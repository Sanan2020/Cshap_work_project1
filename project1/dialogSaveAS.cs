...
namespace project1
{
    public partial class dialogSaveAS : Office2007Form
    {
        ...
        int pageCount;
        private void dialogSaveAS_Load(object sender, EventArgs e)
        {
            change();
            /* try
             {
        ...
        public async void change() {
            ...
            foreach (string img in Form1.form1.file)
            {
                ...
                for (var pageNumber = 1; pageNumber <= pageCount; pageNumber++)
                {
                    ...
                    // _rasterCodecs.Save(rasterImage, "", RasterImageFormat.Bmp, 4);
                    // _rasterCodecs.Save(rasterImage, @"C:\Users\Administrator\Downloads\in\B.bmp", RasterImageFormat.Bmp, 4);
                    //return rasterImage;
                    //retn = rasterImage;
                    //SaveImage(rasterImage, pageNumber);

                    // Savepdf(rasterImage, pageNumber);
                    /* if (pageNumber ==6) {
                     docWriter.EndDocument();
                     }*/
                    ...
                    if (Form1.form1.fill == "pdf")
                    {
                        ...
                        SaveImage(rasterImage, pageNumber, Form1.form1.fill);
                    }
                }//loop
